...
home_v2_expect( str_contains( $styles, 'Modern art direction' ) && str_contains( $styles, 'radial-gradient(circle at 12% 14%' ), 'The four-color atmosphere is composed on the body canvas.' );
