...
home_v2_expect( str_contains( $styles, '--v2-spectrum-peach: #f4d9d0;' ) && str_contains( $styles, '--v2-spectrum-violet: #a28ebf;' ) && str_contains( $styles, '--v2-spectrum-blue: #5898cc;' ), 'The reference peach, violet, and blue spectrum is defined as the central palette.' );
home_v2_expect( str_contains( $styles, '--v2-spectrum: linear-gradient(110deg, var(--v2-spectrum-peach) 0%, var(--v2-spectrum-violet) 50%, var(--v2-spectrum-blue) 100%);' ), 'The core background follows a full three-color transition.' );
