...
home_v2_expect( str_contains( $styles, '--v2-spectrum: linear-gradient(110deg, var(--v2-spectrum-light) 0%, var(--v2-spectrum-light) 23%, var(--v2-spectrum-peach) 43%, var(--v2-spectrum-violet) 57%, var(--v2-spectrum-blue) 77%, var(--v2-spectrum-blue) 100%);' ), 'The core background gives the light and blue endpoints the strongest visual weight.' );
