...
home_v2_expect( ! str_contains( $theme, 'exclude_donation_link' ) && ! str_contains( $theme, 'cammino_is_donation_menu_url' ), 'The shared header keeps every WordPress menu item alongside its independent donation CTA.' );
