...
home_expect( str_contains( $styles, '.home-page .community-cta' ) && str_contains( $styles, 'background: #17343b;' ) && str_contains( $styles, '.community-cta-copy > p' ), 'The standard homepage community CTA has a deep-blue background and styled project copy.' );
