...
$contact_fresh = '<main id="main-content"><section class="contact-hero" aria-labelledby="contact-title"><div class="contact-hero__grid"><div class="contact-intro"><h1 id="contact-title">Kontakt</h1></div></div></section><section class="contact-team-section" aria-labelledby="contact-team-title"><div class="info-card" data-nstarter-variable-section="contact_people_count" data-nstarter-variable-value="2"><div class="info-intro"><h2 id="contact-team-title">Náš tím</h2></div><div class="contact-people" data-nstarter-variable-items><article class="contact-person" data-nstarter-variable-item><div class="contact-person__icon" aria-hidden="true"><i class="fa-solid fa-user"></i></div><div><span>Role</span><h3>Default</h3><a href="mailto:default@example.com">default@example.com <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a></div></article></div><template data-nstarter-variable-template><article class="contact-person" data-nstarter-variable-item><div class="contact-person__icon" aria-hidden="true"><i class="fa-solid fa-user"></i></div><div><span>Role</span><h3>Default</h3><a href="mailto:default@example.com">default@example.com <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a></div></article></template></div></section></main>';
$contact_old = '<main id="main-content"><section class="contact-hero" aria-labelledby="contact-title"><div class="contact-hero__grid"><div class="contact-intro"><h1 id="contact-title">Kontakt</h1><div class="contact-people"><article class="person-card"><div class="person-card__icon" aria-hidden="true"><i class="fa-solid fa-star"></i></div><div><span>Saved role</span><h2>Saved name</h2><a href="mailto:saved@example.com">saved@example.com <i class="fa-solid fa-arrow-right" aria-hidden="true"></i></a></div></article></div></div></div></section></main>';
