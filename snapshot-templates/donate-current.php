...
?>
  ...
  <header class="site-header" data-header>
    <div class="container header-inner">
      ...
      <nav class="site-nav" id="site-nav" aria-label="Hlavná navigácia" data-nav>
        ...
        <a class="button button--small button--coral nav-donate" href="<?php echo esc_url( $cammino_campaign_url ); ?>" target="_blank" rel="noopener noreferrer">Prispieť <i class="fa-solid fa-heart" aria-hidden="true"></i></a>
      </nav>
    </div>
  </header>
  ...
  <footer class="site-footer">
    <div class="container footer-main">
      ...
      <div class="footer-links">
        <h2>Zapojte sa</h2>
        <a href="<?php echo esc_url( $cammino_campaign_url ); ?>" target="_blank" rel="noopener noreferrer">Podporte nás</a>
        <a href="#">Pre firmy</a>
