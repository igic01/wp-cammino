...
define( 'NSTARTER_VERSION', '1.10.18' );
...
function cammino_register_live_sections(): void {
	...
	nstarter_register_live_section( 'cammino_home_events', 'cammino_render_home_events' );
...
function cammino_enqueue_visual_page_assets(): void {
	...
	$pages = array(
		...
		'home-v2'  => array(
			'handle' => 'cammino-home-v2',
			'style'  => '/assets/home-v2/home-v2.css',
			'script' => '/assets/js/pages/home.js',
			'before_styles' => array(
				'cammino-home-v2-base' => '/assets/css/pages/home.css',
			),
		),
		'home-v3'  => array(
			'handle' => 'cammino-home-v3',
			'style'  => '/assets/home-v3/home-v3.css',
			'script' => '/assets/js/pages/home.js',
			'before_styles' => array(
				'cammino-home-v3-base' => '/assets/css/pages/home.css',
			),
		),
		'about-us' => array(
...
function cammino_enqueue_design_assets( string $handle, string $style, string $script, array $before_styles = array() ): void {
	...
	wp_enqueue_style( $handle, NSTARTER_URL . $style, $style_dependencies, NSTARTER_VERSION . '-' . filemtime( NSTARTER_PATH . $style ) );
...
function cammino_visual_page_body_classes( array $classes ): array {
	if ( is_page() ) {
		...
		$page_classes = array(
			...
			'home-v2'       => array( 'home-page', 'home-v2-page' ),
			'home-v3'       => array( 'home-page', 'home-v3-page' ),
